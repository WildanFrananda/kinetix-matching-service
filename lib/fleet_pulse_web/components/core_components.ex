defmodule FleetPulseWeb.CoreComponents do
  @moduledoc """
  ...
  ## Examples
      ...
      <.button navigate={~p"/dispatch"}>Dispatch</.button>
  """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FleetPulseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FleetPulseWeb.Gettext, "errors", msg, opts)
    end
  end
